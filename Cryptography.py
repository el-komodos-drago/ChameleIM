...
print("hash 4: "+Hash("Alpha", b"new")[0]) #Test 5b: this has the same string but a new salt.
print("hash 5: "+Hash("Beta", b"new")[0]) #Test 5c: this has a different salt and string.